...
router
    .get("/", authenticateJwt, hasRoles(["admin"]), getEstudiantes) // Lista todos los estudiantes o filtra por nombre, email, etc.
    .get("/detail", authenticateJwt, hasRoles(["admin"]), getEstudiante) // Busca un estudiante por id, nombre, email, etc.
